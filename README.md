...
──────────           ───────────           ─────────────────       ──────────────
HTML5 / CSS3         Node.js               PostgreSQL              Responsive Design
JavaScript           Express               Sequelize               Mobile-First
TypeScript           API REST              Redis & MongoDB         Tests (TU, TI, E2E)
React                GraphQL               Git & GitHub            CI/CD, Docker
...
> *"La technologie médicale m'a appris la précision, le développement logiciel me permet de créer des solutions qui comptent vraiment."*
